...
from University_Faculty.exam.models import Exam, Result, Subject
...
class Student(models.Model):
    ...
    PROFILE_PICTURE_UPLOAD_TO_DIRECTORY = 'accounts/'

    exams = models.ManyToManyField(Exam, through=Result)

    interests = models.ManyToManyField(Subject, related_name='interest_students')
